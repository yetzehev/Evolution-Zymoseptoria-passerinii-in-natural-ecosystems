...
RNAseq_bam=/home/rojas/Zpasserinii/1_PacBio_assembly/6_braker_RNA/trimming/bbduk/bam/Zpa796.allReads.bbduk.hisat2.bam #BamFile with reads aligned against reference genome to annotate
...
targetSp=/groups/envgenom/Alice_Feurtey/Scripts/Assemblies_and_annotations/2_Annotations/Orthofinder/Zpa63_EVM.all.shorter_names.prot.fasta #Path to the fasta file that contains the protein sequence for your target species. In this case is protein annotation for Z. passerinii isolate Zpa63
